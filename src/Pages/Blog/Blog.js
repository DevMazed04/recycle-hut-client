...
const Blog = () => {
  return (
    <div>
      <h3 className="text-3xl text-center my-10 font-semibold text-gray-600 w-[85%] mx-auto">React Interview Questions</h3>

      <div className="accordion w-[85%] lg:w-[95%] mx-auto" id="accordionExample">
